...
activities = {
    ...
    "Swimming Club": {
        "description": "Train in swimming techniques and participate in swim meets",
    ...
    "Drama Club": {
        "description": "Develop acting and stage production skills for school performances",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and compete in academic debate tournaments",
